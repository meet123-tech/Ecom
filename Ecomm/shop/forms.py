...
class UserInfoForm(forms.ModelForm):
    ...
    phone = forms.CharField(label="", max_length=20,  widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Phone Number'}), required=False)
    address1 = forms.CharField(label="", max_length=100,  widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Address Line 1'}), required=False)
    address2 = forms.CharField(label="", max_length=100, widget=forms.TextInput(
    ...
    zip_code = forms.CharField(label="", max_length=10,  widget=forms.TextInput(
        attrs={'class': 'form-control', 'placeholder': 'Zip Code'}), required=False,)
    country = forms.CharField(label="", max_length=100, widget=forms.TextInput(
